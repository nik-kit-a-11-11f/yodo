...
(1, 'Кафедра Программирования', 'Алексей Волков', 'prog@university.edu'),
(1, 'Кафедра Искусственного Интеллекта', 'Ольга Новикова', 'ai@university.edu'),
(1, 'Кафедра Кибербезопасности', 'Павел Орлов', 'cyber@university.edu'),
(2, 'Кафедра Финансов', 'Елена Кузнецова', 'finance@university.edu'),
(2, 'Кафедра Менеджмента', 'Артем Лебедев', 'management@university.edu'),
(3, 'Кафедра Английского Языка', 'Татьяна Морозова', 'english@university.edu'),
(3, 'Кафедра Немецкого Языка', 'Виктор Зайцев', 'german@university.edu'),
(4, 'Кафедра Алгебры', 'Надежда Павлова', 'algebra@university.edu'),
(4, 'Кафедра Математического Анализа', 'Григорий Семенов', 'analysis@university.edu'),
(5, 'Кафедра Теоретической Физики', 'Михаил Попов', 'theory@university.edu'),
(5, 'Кафедра Экспериментальной Физики', 'Людмила Васильева', 'experiment@university.edu');
...
(1, 'Андрей', 'Ковалев', 'Доктор наук', 85000.00, '2010-09-01', 'a.kovalev@university.edu', '+7-900-111-2233'),
(1, 'Светлана', 'Михайлова', 'Кандидат наук', 75000.00, '2015-03-15', 's.mikhailova@university.edu', '+7-900-222-3344'),
(2, 'Константин', 'Никитин', 'Доктор наук', 90000.00, '2008-11-20', 'k.nikitin@university.edu', '+7-900-333-4455'),
(2, 'Екатерина', 'Федорова', 'Кандидат наук', 78000.00, '2017-08-10', 'e.fedorova@university.edu', '+7-900-444-5566'),
(3, 'Роман', 'Дмитриев', 'Доктор наук', 82000.00, '2012-05-30', 'r.dmitriev@university.edu', '+7-900-555-6677'),
(4, 'Наталья', 'Алексеева', 'Кандидат наук', 70000.00, '2019-01-12', 'n.alekseeva@university.edu', '+7-900-666-7788'),
(5, 'Игорь', 'Соколов', 'Доктор наук', 88000.00, '2009-07-22', 'i.sokolov@university.edu', '+7-900-777-8899'),
(6, 'Оксана', 'Егорова', 'Кандидат наук', 65000.00, '2016-04-05', 'o.egorova@university.edu', '+7-900-888-9900'),
(7, 'Вадим', 'Тихонов', 'Доктор наук', 72000.00, '2014-10-18', 'v.tikhonov@university.edu', '+7-900-999-0011'),
(8, 'Лариса', 'Романова', 'Кандидат наук', 68000.00, '2018-02-28', 'l.romanova@university.edu', '+7-900-000-1122'),
(9, 'Станислав', 'Воробьев', 'Доктор наук', 87000.00, '2011-12-10', 's.vorobiev@university.edu', '+7-900-112-2334'),
(10, 'Алина', 'Полякова', 'Кандидат наук', 76000.00, '2017-06-14', 'a.polyakova@university.edu', '+7-900-223-3445'),
(11, 'Геннадий', 'Медведев', 'Доктор наук', 91000.00, '2007-03-25', 'g.medvedev@university.edu', '+7-900-334-4556');
